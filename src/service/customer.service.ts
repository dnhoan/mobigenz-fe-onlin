...
export class CustomerService {
  ...
  getCustomers(): Observable<any> {
    return this.http.get<any>(
      'http://localhost:8080/api/user/customers/getAllCus'
    );
  }
  ...
  getCustomerById(id: any): Observable<any> {
    return this.http.get<any>(
      this.apiCustomer + 'admin/customers/getCustomerById' + id
    );
  }
  ...
  getCustomerByAccountId(accountId: any): Observable<any> {
    return this.http.get<any>(
      this.apiCustomer +
        'admin/customers/getCustomerByAccountId?accountId=' +
        accountId
    );
  }
  ...
  public userGetCustomerByEmail(email: any): Observable<any> {
    return this.http.get<any>(
      'http://localhost:8080/user/customers/email?email=' + email
    );
  }
}
